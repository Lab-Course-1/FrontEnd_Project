      ...
      <div className="container">
        ...
        <div className="container">
          ...
          <div className="card">
            ...
            <NavLink to='/admin/dbentities/addressdetails'>View AddressDetails</NavLink>
          </div>
          <div className="card">
            <h4>OrderDetails</h4>
            <p>Dashboard for details of orders</p>
            <NavLink to='/admin/dbentities/orderdetails'>View OrderDetails</NavLink>
          </div>
          <div className="card">
            <h4>Products</h4>
          ...
          <div className="card">
            ...
            <NavLink to='/admin/dbentities/productorderdetails'>View ProductOrderDetails</NavLink>
          </div>
          <div className="card">
            <h4>Promotions</h4>
          ...
          <div className="card">
            ...
            <NavLink to='/admin/dbentities/wishListItem'>View WishListItems</NavLink>
          </div>
        </div>
      </div>
    </div >
